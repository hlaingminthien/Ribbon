  ...
  return (
    <div className='pb-4'>
      ...
      {(complete && step == 3 && showThankU) && (
        <ThankYouCard _handleEdit={_handleEdit} recipientName={recipientName} senderName={senderName} message={message} media={media} step={step} imgUrl={imgUrl} setImgUrl={setImgUrl} cancer={cancer} finalImage = {finalImage}    _handlePledge={_handlePledge} downloadImg={downloadImg} setShareApp={setShareApp} setShowThankU={setShowThankU}  shareApp={shareApp} winner={winner} />
      )}
    </div>
  );
};
