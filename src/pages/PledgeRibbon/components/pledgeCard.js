      ...
      >
        ...
        {(imgUrl || recipientName || senderName || message) && (
          <div className={`${!imgUrl && "pt-1 px-1" }`} style={{ position: "absolute", right: 10 }}>
            ...
            />
              <svg viewBox="-12 2 115 56" xmlns="http://www.w3.org/2000/svg" style={{ zIndex: 100, position: 'absolute',
                ...
                <text fontSize={10} fontWeight={600} fill="white">
                  <textPath href="#curve-path" startOffset={(45 - (cancer ? cancer.length : 18) - 15 * 2) + "%"}>
